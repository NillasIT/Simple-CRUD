...
<body>
  ...
  <div class="container">
    ...
    <form action="{{ route('produto.store')}}" method="POST">
        ...
        <div class="col-8">
            <input type="text" name="name" class="form-control" placeholder="Digite o nome do Produto" value="{{ old('name') }}">
        </div>
        ...
        <div class="col-8">
            <input type="text" name="description" class="form-control" placeholder="Digite a descrição do Produto" value="{{ old('description') }}">
        </div>
        ...
        <div class="col-8">
            <input type="text" name="category" class="form-control mb-3" placeholder="Digite a Categoria do Produto" value="{{ old('category') }}">
        </div>
